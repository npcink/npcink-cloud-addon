	...
	final class Npcink_Cloud_Addon_Localization {
		...
		public static function translations(): array {
			return array(
				...
				'Available images' => '可用图片数',
				'Unlimited' => '无限制',
				'Remaining image recognition capacity percentage' => '剩余图片识别额度占比',
				'%1$d of %2$d' => '%1$d / %2$d',
				...
				'Recognized: %1$d images; visual evidence: %2$d; not included: %3$d.' => '已识别：%1$d 张图片；视觉证据：%2$d 条；未纳入识别：%3$d 张。',
				'Processed: %1$d eligible images; visual evidence: %2$d; excluded locally: %3$d; without visual evidence: %4$d.' => '已处理：%1$d 张符合条件的图片；视觉证据：%2$d 条；本地筛除：%3$d 张；暂无视觉证据：%4$d 张。',
				...
				'Processed %1$d of %2$d eligible images. Cloud processing time: %3$s seconds.' => '已处理 %2$d 张符合条件图片中的 %1$d 张。Cloud 处理用时：%3$s 秒。',
				'Newly recognized / reused' => '新识别 / 复用',
				'Excluded locally' => '本地筛除',
				'Processed without visual evidence' => '已处理但暂无视觉证据',
				'Media library inventory' => '媒体库图片总数',
				'%d image attachments' => '%d 个图片附件',
				'Not available for an earlier plan' => '此前计划未记录拆分数据',
				'Not applicable after completion' => '完成后不再适用',
				'Plan' => '套餐',
				'%1$d concurrent task(s); up to %2$d images per batch' => '%1$d 个并发任务；每批最多 %2$d 张图片',
				...
				'Your plan has %s image recognition slots remaining.' => '当前套餐还可识别 %s 张图片。',
				...
				'The current batch is running. Remaining images will continue automatically.' => '当前批次正在识别，剩余图片会自动继续处理。',
				...
				'Available AI credits are insufficient. Review the plan or add credits before continuing.' => '可用 AI 点数不足。请查看套餐或补充点数后再继续。',
				'This batch exceeds the platform daily media recognition limit. Reduce the batch or adjust the limit in Cloud administration.' => '本批任务超出平台每日媒体识别上限。请减少批量数量，或在 Cloud 管理后台调整上限。',
				'Background media recognition is disabled in Cloud administration.' => 'Cloud 管理后台已关闭后台媒体识别。',
				'The configured image recognition model is not available. Verify the vision.ai runtime profile in Cloud administration.' => '配置的识图模型当前不可用。请在 Cloud 管理后台验证“视觉理解”运行配置。',
				'The image recognition provider quota is exhausted. Check the provider account before retrying.' => '识图服务商额度已用尽。请检查服务商账户后重试。',
				'Image recognition timed out. Retry this batch later.' => '图片识别超时。请稍后重试本批。',
				'Images were recognized, but Cloud could not update the media search index. Retry this batch later.' => '图片已完成识别，但 Cloud 未能更新媒体搜索索引。请稍后重试本批。',
				'This recognition task is no longer available. Retry this batch to continue.' => '这次识别任务已不可用。请重试本批以继续。',
				'Another Cloud task is already running. Please wait for it to finish, then try again.' => '当前已有 Cloud 任务正在运行，请等待完成后再试。',
				'Cloud media recognition did not complete. Retry this batch later.' => 'Cloud 媒体识别未完成。请稍后重试本批。',
