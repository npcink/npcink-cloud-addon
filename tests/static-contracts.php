...
maca_assert(
	...
	&& false !== strpos( $wp_ai_text_browser_smoke, 'remainingDelta === -expectedCreditDelta' )
	&& false !== strpos( $wp_ai_text_browser_smoke, 'creditAfter.limit === creditBefore.limit' )
...
maca_assert(
	...
	&& false !== strpos( $settings_page, 'Available AI credits' )
	...
	&& false !== strpos( $settings_page, 'npcink-cloud-overview-panel__metrics' )
	...
	&& false !== strpos( $admin_css, 'grid-template-columns: repeat(3, minmax(0, 1fr))' )
	...
	&& false !== strpos( $admin_css, '.npcink-cloud-overview-panel' )
	&& false === strpos( $settings_page, "format_credit_amount( \$remaining, \$unit )" )
	&& false !== strpos( $settings_page, 'Used %1$s AI credits; remaining %2$s AI credits; limit %3$s AI credits.' )
	&& false !== strpos( $settings_page, 'npcink-cloud-section-heading' )
	&& false !== strpos( $settings_page, 'View AI credit details in Cloud' )
...
maca_assert(
	...
	&& false !== strpos( $settings_page, 'Start indexing' )
	&& false !== strpos( $settings_page, 'npcink-cloud-site-knowledge-summary__scope' )
	&& false !== strpos( $settings_page, 'npcink-cloud-site-knowledge-summary__status' )
	&& false !== strpos( $settings_page, 'npcink-cloud-site-knowledge-summary__meta' )
	&& false === strpos( $settings_page, 'npcink-cloud-site-knowledge-consent' )
	...
	&& false !== strpos( $settings_page, 'npcink-cloud-site-knowledge-summary__action' )
